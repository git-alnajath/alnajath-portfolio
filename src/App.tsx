...
export default function App() {
  ...
  useEffect(() => {
    ...
    let raf: number;
    function animRing() {
      ringRef.current.x += (targetRef.current.x - ringRef.current.x) * 0.5;
      ringRef.current.y += (targetRef.current.y - ringRef.current.y) * 0.5;
  ...
  return (
    ...
    >
      ...
      />
      <div
        className="fixed pointer-events-none z-40 rounded-full border transition-all duration-300"
        style={{
          width: 32,
          height: 32,
          top: ring.y,
      ...
      {/* Progress */}
      <div
        className="fixed top-0 left-0 h-0.5 z-50 transition-none"
        style={{
          width: `${progress}%`,
          background: "linear-gradient(90deg,#7f1d1d,#e53e3e,#fc8181)",
        }}
      />

      {/* NAV */}
      {/* NAV */}
      <Navbar activeNav={activeNav} scrolled={scrolled} />
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            height: 700,
            background:
              "radial-gradient(circle,rgba(229,62,62,0.07) 0%,transparent 65%)",
            transform: "translate(-50%,-50%)",
            top: "50%",
            left: "50%",
          }}
        ...
        <div className="relative z-20 flex flex-col items-center w-full max-w-5xl">
          <div
            className="inline-flex items-center gap-2 text-xs tracking-widest uppercase rounded-full px-5 py-1.5 mb-12 border"
            style={{
          ...
          <p
            className="text-sm md:text-base leading-loose mb-11 max-w-md"
            style={{ color: "#555" }}
          >
            Frontend developer specializing in React.js &amp; Next.js — crafting
            production-grade e-commerce experiences with TypeScript, Tailwind
            CSS, and Redux.
          </p>
            ...
            <button
              ...
              onMouseEnter={(e) =>
                (e.currentTarget.style.boxShadow =
                  "0 12px 36px rgba(229,62,62,0.4)")
              }
          ...
          <div className="flex gap-2 flex-wrap justify-center">
            {TECH.map((t) => (
              <span
                key={t}
                className="text-xs px-3 py-1 rounded-sm border transition-all duration-200 hover:-translate-y-0.5"
                style={{
                  fontFamily: "'JetBrains Mono',monospace",
                  color: "#444",
                  borderColor: "rgba(229,62,62,0.1)",
                ...
                onMouseLeave={(e) => {
                  ...
                  e.currentTarget.style.borderColor = "rgba(229,62,62,0.1)";
                }}
              >
                {t}
              </span>
        ...
        >
          <div
            ...
            style={{ width: 18, height: 28, border: "1px solid #222" }}
          >
            <div
              ...
              style={{
                ...
                height: 5,
                background: "#e53e3e",
                animation: "sdrop 1.8s ease infinite",
              }}
            />
          </div>
          <span
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg,transparent,rgba(229,62,62,0.1),transparent)",
        }}
      />
      ...
      <Section id="about" num="01" title="Who I am">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-start">
          ...
          >
            <p>
              I'm a{" "}
              <strong className="text-gray-200">Frontend Developer</strong>{" "}
              working as a Software Engineer Trainee at{" "}
              <strong className="text-gray-200">TetraDtech Solutions</strong> in
              Chennai. I hold a Master's in Computer Applications from B.S.
              Abdur Rahman Crescent Institute.
            </p>
            <p>
              I independently own the frontend architecture of a
              production-grade e-commerce platform — from UI design and REST API
              integration to Redux state management and responsive layouts.
            </p>
            <p>
              I love solving real-world problems through clean, performant code.
              When I'm not building UIs, I'm studying how platforms like{" "}
              <strong className="text-gray-200">
                Flipkart, Amazon, and Myntra
              </strong>{" "}
              architect their frontends.
            </p>
          </div>
      ...
      <Section id="experience" num="02" title="Where I've worked">
        <div className="grid md:grid-cols-[180px_1fr] gap-10">
          ...
          <div
            ...
            style={{ borderLeft: "1px solid rgba(229,62,62,0.2)" }}
          >
            <div
              className="absolute -left-1.5 top-2 w-3 h-3 rounded-full"
              style={{ background: "#e53e3e", boxShadow: "0 0 12px #e53e3e" }}
            />
            ...
            <ul className="flex flex-col gap-3">
              {EXP.bullets.map((b, i) => (
                <li
                  key={i}
                  className="text-sm pl-5 relative leading-relaxed transition-colors duration-200 group"
                  style={{ color: "#555" }}
                >
                  <span
                    className="absolute left-0 transition-transform duration-200 group-hover:translate-x-1"
                    style={{ color: "#e53e3e" }}
                  >
                    ▸
                  </span>
      ...
      <Section id="projects" num="03" title="Things I've built">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {PROJECTS.map((p, i) => (
            <ProjCard key={p.num} p={p} delay={i * 100} />
          ))}
        </div>
      </Section>
      ...
      <Section id="skills" num="04" title="What I work with">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {SKILL_GROUPS.map((g, i) => (
            <SkillGroup key={g.title} group={g} delay={i * 100} />
          ))}
        </div>
      </Section>
      ...
      <Section id="contact" num="05" title="Let's connect">
        <div
          className="rounded-xl p-8 md:p-16 border grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative overflow-hidden"
        ...
        >
          ...
          <div>
            <p className="text-sm leading-loose mb-7" style={{ color: "#555" }}>
              I'm open to frontend developer roles, freelance projects, and
              collaborations. Whether it's a full-scale e-commerce platform or a
            ...
            <div className="flex flex-col gap-3">
              {CONTACT_LINKS.map((l) => (
                ...
                >
                  <div
                    className="w-9 h-9 rounded-lg flex items-center justify-center text-sm flex-shrink-0 border transition-all duration-250 group-hover:border-red-500"
                    style={{
                      background: "#181818",
      ...
      <footer
        className="text-center py-9 border-t"
        style={{
          fontFamily: "'JetBrains Mono',monospace",
          fontSize: 11,
          color: "#333",
          borderColor: "rgba(229,62,62,0.08)",
        }}
      >
        Crafted with ❤️ by <span style={{ color: "#e53e3e" }}>Al Najath J</span>{" "}
